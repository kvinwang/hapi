export default {
  ...
  'sessions.noFavoritesHint': 'Long-press or right-click a session to add it to favorites.',
  'session.action.favorite': 'Add to favorites',
  'session.action.unfavorite': 'Remove from favorites',
  ...
  'composer.attachPerformanceReport': 'Attach performance report',
  ...
  'settings.chat.staleCacheIdle': 'Idle cache warning after',
  ...
  'settings.sessions.closeStale': 'Close sessions idle for 10+ days',
  'settings.sessions.closeStale.description': 'Archives running sessions with no activity in the last 10 days. Pinned sessions, and parents with a live child that should stay, are left alone.',
  'settings.sessions.closeStale.confirm': 'Close {n} sessions idle for more than 10 days? Their agents will be stopped.',
  'settings.sessions.closeStale.confirmButton': 'Close',
  'settings.sessions.closeStale.progress': 'Closing {done} / {total}…',
  'settings.sessions.closeStale.stop': 'Stop',
  'settings.sessions.closeStale.done': 'Closed {n} sessions.',
  'settings.sessions.closeStale.none': 'No running sessions idle for more than 10 days.',
  'settings.sessions.closeStale.failed': '{n} could not be closed.',
  'settings.sessions.closeStale.stopped': 'Stopped early.',
  ...
  'settings.group.models': 'Models & Agents',
  ...
  'settings.providers.description': 'LLM provider API keys that agents can be pointed at.',
  'settings.providers.add': 'Add provider',
  'settings.providers.empty': 'No providers configured',
  'settings.apiKeys.description': 'Keys that let CLIs, runners and scripts act as this account.',
  'settings.apiKeys.create': 'Create API key',
  'settings.speakers.add': 'Add speaker',
  'settings.machines.total': '{n} total',
  'settings.addDevice.install': 'Install',
  'settings.addDevice.quickJoinDescription': 'Create a one-time invite so someone else can join their machine to this hub.',
  'settings.sessions.pruneEmpty.title': 'Empty sessions',
  'settings.sessions.closeStale.title': 'Idle sessions',
  'settings.summary.chat': '{n} messages per page',
  'settings.summary.providers': 'Providers: {n}',
  'settings.summary.onlineMachines': 'Machines online: {n}',
  'settings.summary.machines': '{online} online · {total} total',
  'settings.summary.sessions': 'Clean up empty and idle sessions',
  'settings.summary.apiKeys': 'API keys: {n}',
  'settings.summary.version': 'Version {v}',
  ...
  'settings.time.inUnderMinute': 'in <1m',
  'settings.time.inMinutes': 'in {n}m',
  'settings.time.inHours': 'in {n}h',
  'settings.time.inDays': 'in {n}d',
  'settings.addDevice.download': 'Download',
  'settings.addDevice.browser': 'Browser',
  'settings.providers.moreModels': ' +{n} models',
  'settings.providers.applyToMachine': 'Apply to machine',
  'settings.providers.duplicate': 'Duplicate',
  'settings.providers.copyName': '{name} (copy)',
  'settings.providers.selectMachine': 'Select machine…',
  'settings.providers.applyToAgent': 'Apply to agent',
  'settings.providers.applyTo': 'Apply to {agent}',
  'settings.providers.apply': 'Apply',
  'settings.providers.applying': 'Applying…',
  'settings.providers.applied': 'Applied to {agent}: {files}',
  'settings.providers.appliedDone': 'done',
  'settings.providers.form.editTitle': 'Edit Credential',
  'settings.providers.form.newTitle': 'New Credential',
  'settings.providers.form.displayName': 'Display name',
  'settings.providers.form.providerId': 'Provider ID (e.g. openrouter)',
  'settings.providers.form.apiKey': 'API key',
  'settings.providers.form.showKey': 'Show API key',
  'settings.providers.form.hideKey': 'Hide API key',
  'settings.providers.form.endpoints': 'Endpoints · usable by {agents}',
  'settings.providers.form.noAgent': 'no agent yet',
  'settings.providers.form.protocol': 'Protocol',
  'settings.providers.form.baseUrl': 'Base URL',
  'settings.providers.form.removeEndpoint': 'Remove endpoint',
  'settings.providers.form.addEndpoint': 'Add endpoint',
  'settings.providers.form.headers': 'Extra headers (optional, one "Name: value" per line)',
  'settings.providers.form.models': 'Models · the selected one is the default',
  'settings.providers.form.fetching': 'Fetching…',
  'settings.providers.form.fetch': 'Fetch from API',
  'settings.providers.form.autoSync': 'Auto-sync hourly: mirror the API model list, keeping edits to existing models',
  'settings.providers.form.noModels': 'No models yet',
  'settings.providers.form.defaultModel': 'Default {id}',
  'settings.providers.form.context': 'Context',
  'settings.providers.form.contextFor': 'Context window for {id}',
  'settings.providers.form.removeModel': 'Remove {id}',
  'settings.providers.form.addModelId': 'Add model ID',
  'settings.providers.form.filterFetched': 'Filter {n} fetched models',
  'settings.providers.form.addAllShown': 'Add all shown',
  'settings.providers.form.importFromMachine': 'Import from machine…',
  'settings.providers.form.importFromAgent': 'Import from agent',
  'settings.providers.form.agentConfig': '{agent} config',
  'settings.providers.form.reading': 'Reading…',
  'settings.providers.form.import': 'Import',
  'settings.providers.form.listModelsFailed': 'Unable to list models',
  'settings.providers.form.nothingToImport': 'Nothing to import',
  'settings.providers.form.importFailed': 'Import failed',
  'settings.providers.form.nameRequired': 'Name is required',
  'settings.providers.form.saveFailed': 'Failed to save',
  'settings.apiKeys.perm.manageApiKeys': 'Manage API Keys',
  'settings.apiKeys.perm.manageApiKeys.description': 'Create, list, and revoke API keys and tokens',
  'settings.apiKeys.perm.readSessions': 'Read Sessions',
  'settings.apiKeys.perm.readSessions.description': 'View sessions, messages, and history',
  'settings.apiKeys.perm.readAllSessions': 'Read All Sessions',
  'settings.apiKeys.perm.readAllSessions.description': 'View sessions across all namespaces',
  'settings.apiKeys.perm.writeSessions': 'Write Sessions',
  'settings.apiKeys.perm.writeSessions.description': 'Create and load sessions',
  'settings.apiKeys.perm.readMachines': 'Read Machines',
  'settings.apiKeys.perm.readMachines.description': 'List and view machines',
  'settings.apiKeys.perm.readAllMachines': 'Read All Machines',
  'settings.apiKeys.perm.readAllMachines.description': 'View machines across all namespaces',
  'settings.apiKeys.perm.writeMachines': 'Write Machines',
  'settings.apiKeys.perm.writeMachines.description': 'Register and update machines',
  'settings.apiKeys.perm.connectMachines': 'Connect Machines',
  'settings.apiKeys.perm.connectMachines.description': 'Create tunnel connections to machines',
  'settings.apiKeys.perm.shell': 'Shell Access',
  'settings.apiKeys.perm.shell.description': 'Access built-in SSH shell (port 0)',
  'settings.apiKeys.perm.manageMachines': 'Manage Machines',
  'settings.apiKeys.perm.manageMachines.description': 'Delete machines and manage bindings',
  'settings.apiKeys.perm.manageSsh': 'Manage SSH Keys',
  'settings.apiKeys.perm.manageSsh.description': 'Import SSH public keys to remote machines',
  'settings.apiKeys.preset.none': 'None',
  'settings.apiKeys.preset.readOnly': 'Read Only',
  'settings.apiKeys.preset.vibeCoder': 'Vibe Coder',
  'settings.apiKeys.preset.runner': 'Runner',
  'settings.apiKeys.preset.admin': 'Admin',
  'settings.apiKeys.fullAccess': 'Full access — all permission checks bypassed',
  'settings.apiKeys.expiry': 'Expiry',
  'settings.apiKeys.expiry.1d': '1 Day',
  'settings.apiKeys.expiry.7d': '1 Week',
  'settings.apiKeys.expiry.30d': '1 Month',
  'settings.apiKeys.expiry.never': 'Never',
  'settings.apiKeys.copyNow': 'Copy now. It will not be shown again.',
  'settings.apiKeys.revoked': 'Revoked',
  'settings.apiKeys.expired': 'Expired',
  'settings.apiKeys.neverExpires': 'Never expires',
  'settings.apiKeys.expires': 'Expires {time}',
  'settings.apiKeys.tokenName': 'Token name',
  'settings.apiKeys.loadingTokens': 'Loading tokens…',
  'settings.apiKeys.tokenCreated': 'Token Created',
  'settings.apiKeys.noTokens': 'No access tokens',
  'settings.apiKeys.newToken': '+ New Token',
  'settings.apiKeys.keyName': 'Key name',
  'settings.apiKeys.permissions': 'Permissions',
  'settings.apiKeys.used': 'used {time}',
  'settings.apiKeys.accessTokens': 'Access Tokens',
  'settings.apiKeys.newKey': 'New API Key',
  'settings.apiKeys.keyCreated': 'API Key Created',
  'settings.apiKeys.active': 'Active Keys ({n})',
  'settings.apiKeys.noActive': 'No active API keys',
  'settings.apiKeys.revokedList': 'Revoked Keys ({n})',
  'settings.machines.online': 'Online',
  'settings.machines.offline': 'Offline',
  'settings.machines.onlineBadge': 'ONLINE',
  'settings.machines.onlineCount': 'Online ({n})',
  'settings.machines.offlineCount': 'Offline ({n})',
  'settings.machines.empty': 'No machines registered',
  'settings.machines.host': 'Host',
  'settings.machines.platform': 'Platform',
  'settings.machines.cliVersion': 'CLI version',
  'settings.machines.lastActive': 'Last active',
  'settings.machines.lastSeen': 'Last seen',
  'settings.machines.activeAgo': 'active {time}',
  'settings.machines.lastSeenAgo': 'last seen {time}',
  'settings.machines.notePlaceholder': 'Add a note…',
  'settings.machines.editNotes': 'Edit notes',
  'settings.machines.addNote': 'Add note…',
  'settings.machines.apiKeyId': 'API key ID: {id}',
  'settings.machines.unbound': 'unbound',
  'settings.machines.created': 'created {time}',
  'settings.machines.unbind': 'Unbind',
  'settings.machines.unbindTitle': 'Unbind API key',
  'settings.machines.unbinding': 'Unbinding…',
  'settings.machines.delete': 'Delete machine',
  'settings.machines.deleting': 'Deleting…',
  'settings.speakers.deviceId': 'Device ID',
  'settings.speakers.sessionId': 'Session ID',
  'settings.speakers.sessionIdOptional': 'Session ID (optional)',
  'settings.speakers.adding': 'Adding…',
  'settings.speakers.empty': 'No speakers registered. Add one to get started.',
  'settings.speakers.session': 'session: {id}',
  'settings.speakers.noSession': 'no session',
  'settings.speakers.createFailed': 'Failed to create speaker',
  'settings.speakers.updateFailed': 'Failed to update speaker',
  'settings.speakers.deleteFailed': 'Failed to delete speaker',
