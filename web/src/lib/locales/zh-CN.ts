export default {
  ...
  'session.action.switchAgent': '切换 Agent',
  ...
  'dialog.switchAgent.title': '切换 Agent',
  'dialog.switchAgent.description': '把这个会话交给另一个 agent。对话仍然在同一处，只是背后的 agent 换了。',
  'dialog.switchAgent.current': '（当前）',
  'dialog.switchAgent.resetContext': '重置上下文',
  'dialog.switchAgent.resetContextKnown': '{agent} 之前驾驶过这个会话，否则会接上它自己的记录。',
  ...
  'dialog.staleCache.title': '提示缓存已过期',
  ...
  'composer.attachPerformanceReport': '添加性能报告附件',
  'composer.usage': '用量',
  'composer.send': '发送',
  'composer.stop': '停止',
  'composer.voice': '语音助手',
  ...
  'settings.sessions.closeStale': '关闭超过 10 天未活动的会话',
  'settings.sessions.closeStale.description': '归档最近 10 天没有任何活动的运行中会话。已置顶的会话，以及仍有需要保留的活动子会话的父会话不会动。',
  'settings.sessions.closeStale.confirm': '关闭 {n} 个超过 10 天未活动的会话？对应的 agent 会被停止。',
  'settings.sessions.closeStale.confirmButton': '关闭',
  'settings.sessions.closeStale.progress': '正在关闭 {done} / {total}…',
  'settings.sessions.closeStale.stop': '停止',
  'settings.sessions.closeStale.done': '已关闭 {n} 个会话。',
  'settings.sessions.closeStale.none': '没有超过 10 天未活动的运行中会话。',
  'settings.sessions.closeStale.failed': '{n} 个关闭失败。',
  'settings.sessions.closeStale.stopped': '已提前停止。',
  ...
  'settings.group.models': '模型与代理',
  'settings.group.account': '账户',
  'settings.section.diagnostics': '诊断',
  'settings.chat.history': '历史记录',
  'settings.nav.providers': '模型提供商',
  'settings.providers.description': '供代理使用的 LLM 提供商 API 密钥。',
  'settings.providers.add': '添加提供商',
  'settings.providers.empty': '尚未配置提供商',
  'settings.apiKeys.description': '让 CLI、runner 和脚本以此账户身份操作的密钥。',
  'settings.apiKeys.create': '创建 API 密钥',
  'settings.speakers.add': '添加音箱',
  'settings.machines.total': '共 {n} 台',
  'settings.addDevice.install': '安装',
  'settings.addDevice.quickJoinDescription': '生成一次性邀请，让其他人把自己的机器接入此 hub。',
  'settings.sessions.pruneEmpty.title': '空会话',
  'settings.sessions.closeStale.title': '闲置会话',
  'settings.summary.chat': '每页 {n} 条消息',
  'settings.summary.providers': '提供商：{n}',
  'settings.summary.onlineMachines': '在线机器：{n}',
  'settings.summary.machines': '{online} 台在线 · 共 {total} 台',
  'settings.summary.sessions': '清理空会话和闲置会话',
  'settings.summary.apiKeys': 'API 密钥：{n}',
  'settings.summary.version': '版本 {v}',
  'settings.failed': '失败',
  'settings.saving': '保存中…',
  ...
  'settings.action.revoke': '吊销',
  'settings.action.restore': '恢复',
  'settings.field.name': '名称',
  'settings.time.inUnderMinute': '不到 1 分钟后',
  'settings.time.inMinutes': '{n} 分钟后',
  'settings.time.inHours': '{n} 小时后',
  'settings.time.inDays': '{n} 天后',
  'settings.addDevice.download': '下载',
  'settings.addDevice.browser': '浏览器',
  'settings.providers.moreModels': ' +{n} 个模型',
  'settings.providers.applyToMachine': '应用到机器',
  'settings.providers.duplicate': '创建副本',
  'settings.providers.copyName': '{name}（副本）',
  'settings.providers.selectMachine': '选择机器…',
  'settings.providers.applyToAgent': '应用到代理',
  'settings.providers.applyTo': '应用到 {agent}',
  'settings.providers.apply': '应用',
  'settings.providers.applying': '应用中…',
  'settings.providers.applied': '已应用到 {agent}：{files}',
  'settings.providers.appliedDone': '完成',
  'settings.providers.form.editTitle': '编辑凭据',
  'settings.providers.form.newTitle': '新建凭据',
  'settings.providers.form.displayName': '显示名称',
  'settings.providers.form.providerId': '提供商 ID（如 openrouter）',
  'settings.providers.form.apiKey': 'API 密钥',
  'settings.providers.form.showKey': '显示 API 密钥',
  'settings.providers.form.hideKey': '隐藏 API 密钥',
  'settings.providers.form.endpoints': '端点 · 可用于 {agents}',
  'settings.providers.form.noAgent': '暂无可用代理',
  'settings.providers.form.protocol': '协议',
  'settings.providers.form.baseUrl': 'Base URL',
  'settings.providers.form.removeEndpoint': '移除端点',
  'settings.providers.form.addEndpoint': '添加端点',
  'settings.providers.form.headers': '额外请求头（可选，每行一个 "Name: value"）',
  'settings.providers.form.models': '模型 · 选中项为默认模型',
  'settings.providers.form.fetching': '获取中…',
  'settings.providers.form.fetch': '从 API 获取',
  'settings.providers.form.autoSync': '每小时自动同步：与 API 模型列表保持一致，保留对已有模型的修改',
  'settings.providers.form.noModels': '暂无模型',
  'settings.providers.form.defaultModel': '默认 {id}',
  'settings.providers.form.context': '上下文',
  'settings.providers.form.contextFor': '{id} 的上下文窗口',
  'settings.providers.form.removeModel': '移除 {id}',
  'settings.providers.form.addModelId': '添加模型 ID',
  'settings.providers.form.filterFetched': '筛选已获取的 {n} 个模型',
  'settings.providers.form.addAllShown': '全部添加',
  'settings.providers.form.importFromMachine': '从机器导入…',
  'settings.providers.form.importFromAgent': '从代理导入',
  'settings.providers.form.agentConfig': '{agent} 配置',
  'settings.providers.form.reading': '读取中…',
  'settings.providers.form.import': '导入',
  'settings.providers.form.listModelsFailed': '无法获取模型列表',
  'settings.providers.form.nothingToImport': '没有可导入的内容',
  'settings.providers.form.importFailed': '导入失败',
  'settings.providers.form.nameRequired': '名称不能为空',
  'settings.providers.form.saveFailed': '保存失败',
  'settings.apiKeys.perm.manageApiKeys': '管理 API 密钥',
  'settings.apiKeys.perm.manageApiKeys.description': '创建、列出和吊销 API 密钥与令牌',
  'settings.apiKeys.perm.readSessions': '读取会话',
  'settings.apiKeys.perm.readSessions.description': '查看会话、消息和历史记录',
  'settings.apiKeys.perm.readAllSessions': '读取所有会话',
  'settings.apiKeys.perm.readAllSessions.description': '查看所有命名空间的会话',
  'settings.apiKeys.perm.writeSessions': '写入会话',
  'settings.apiKeys.perm.writeSessions.description': '创建和加载会话',
  'settings.apiKeys.perm.readMachines': '读取机器',
  'settings.apiKeys.perm.readMachines.description': '列出和查看机器',
  'settings.apiKeys.perm.readAllMachines': '读取所有机器',
  'settings.apiKeys.perm.readAllMachines.description': '查看所有命名空间的机器',
  'settings.apiKeys.perm.writeMachines': '写入机器',
  'settings.apiKeys.perm.writeMachines.description': '注册和更新机器',
  'settings.apiKeys.perm.connectMachines': '连接机器',
  'settings.apiKeys.perm.connectMachines.description': '建立到机器的隧道连接',
  'settings.apiKeys.perm.shell': 'Shell 访问',
  'settings.apiKeys.perm.shell.description': '访问内置 SSH shell（端口 0）',
  'settings.apiKeys.perm.manageMachines': '管理机器',
  'settings.apiKeys.perm.manageMachines.description': '删除机器并管理绑定',
  'settings.apiKeys.perm.manageSsh': '管理 SSH 密钥',
  'settings.apiKeys.perm.manageSsh.description': '将 SSH 公钥导入远程机器',
  'settings.apiKeys.preset.none': '无',
  'settings.apiKeys.preset.readOnly': '只读',
  'settings.apiKeys.preset.vibeCoder': 'Vibe Coder',
  'settings.apiKeys.preset.runner': 'Runner',
  'settings.apiKeys.preset.admin': '管理员',
  'settings.apiKeys.fullAccess': '完全访问 — 跳过所有权限检查',
  'settings.apiKeys.expiry': '有效期',
  'settings.apiKeys.expiry.1d': '1 天',
  'settings.apiKeys.expiry.7d': '1 周',
  'settings.apiKeys.expiry.30d': '1 个月',
  'settings.apiKeys.expiry.never': '永不过期',
  'settings.apiKeys.copyNow': '请立即复制，之后将不再显示。',
  'settings.apiKeys.revoked': '已吊销',
  'settings.apiKeys.expired': '已过期',
  'settings.apiKeys.neverExpires': '永不过期',
  'settings.apiKeys.expires': '{time}过期',
  'settings.apiKeys.tokenName': '令牌名称',
  'settings.apiKeys.loadingTokens': '正在加载令牌…',
  'settings.apiKeys.tokenCreated': '令牌已创建',
  'settings.apiKeys.noTokens': '暂无访问令牌',
  ...
  'settings.apiKeys.active': '有效密钥（{n}）',
  'settings.apiKeys.noActive': '暂无有效的 API 密钥',
  'settings.apiKeys.revokedList': '已吊销密钥（{n}）',
  'settings.machines.online': '在线',
  'settings.machines.offline': '离线',
  'settings.machines.onlineBadge': '在线',
  'settings.machines.onlineCount': '在线（{n}）',
  'settings.machines.offlineCount': '离线（{n}）',
  'settings.machines.empty': '尚未注册机器',
  'settings.machines.host': '主机',
  'settings.machines.platform': '平台',
  'settings.machines.cliVersion': 'CLI 版本',
  'settings.machines.lastActive': '最近活跃',
  'settings.machines.lastSeen': '最后在线',
  'settings.machines.activeAgo': '{time}活跃',
  'settings.machines.lastSeenAgo': '最后在线 {time}',
  'settings.machines.notePlaceholder': '添加备注…',
  'settings.machines.editNotes': '编辑备注',
  'settings.machines.addNote': '添加备注…',
  'settings.machines.apiKeyId': 'API 密钥 ID：{id}',
  'settings.machines.unbound': '未绑定',
  'settings.machines.created': '{time}创建',
  'settings.machines.unbind': '解绑',
  'settings.machines.unbindTitle': '解绑 API 密钥',
  'settings.machines.unbinding': '解绑中…',
  'settings.machines.delete': '删除机器',
  'settings.machines.deleting': '删除中…',
  'settings.speakers.deviceId': '设备 ID',
  'settings.speakers.sessionId': '会话 ID',
  'settings.speakers.sessionIdOptional': '会话 ID（可选）',
  'settings.speakers.adding': '添加中…',
  'settings.speakers.empty': '尚未注册音箱，添加一个即可开始使用。',
  'settings.speakers.session': '会话：{id}',
  'settings.speakers.noSession': '无会话',
  'settings.speakers.createFailed': '添加音箱失败',
  'settings.speakers.updateFailed': '更新音箱失败',
  'settings.speakers.deleteFailed': '删除音箱失败',
  ...
  'misc.loadOlderNoChange': '没有显示新内容。本次从 {pages} 页拉取 {received} 条消息：文本 {text} 条，工具/思考活动 {activity} 条，无法识别 {unrecognized} 条。',
  'misc.loadOlderNoResult': '没有显示新内容，也没有拿到本次拉取结果。',
  'misc.loadNewer': '加载更多',
