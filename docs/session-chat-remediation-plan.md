...
| 2026-07-25 | Scroll UX follow-up | (this commit) | Remove content-visibility placeholders that fight manual anchoring; keep follow-bottom across load-older when already at tail; suppress top-sentinel until initial bottom pin settles. | Focused scroll-position + tool-group tests; web typecheck | Passed | Retained |
