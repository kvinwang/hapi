...
- Claude Code, OpenAI Codex CLI, Cursor Agent CLI, Google Gemini CLI, Grok Build CLI, or OpenCode CLI installed
...
|-----------|------|----------|
| **CLI** | Wraps AI agents (Claude/Codex/Cursor/Gemini/Grok/OpenCode), runs sessions | Yes |
